    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white dark:bg-gray-800 shadow-lg rounded-xl overflow-hidden transition-colors duration-200">
            ...
            <div class="divide-y divide-gray-100 dark:divide-gray-700">
                ...
                <a href="{{ route('chat.user', $user->id) }}" class="block hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-150 ease-in-out">
...
<script>
    ...
    document.getElementById('search-users').addEventListener('input', function(e) {
        ...
        userItems.forEach(item => {
            ...
            const userUsername = item.querySelector('.text-gray-500').textContent.toLowerCase();
