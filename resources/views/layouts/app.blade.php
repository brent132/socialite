                ...
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="flex md:hidden items-center space-x-4">
                            ...
                            <button @click="mobileSearch = !mobileSearch" class="text-gray-600 hover:text-indigo-600 transition-colors dark:text-gray-300 dark:hover:text-indigo-400">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div class="hidden md:flex items-center space-x-6">
                            ...
                            <!-- Desktop Search -->
                            <div class="relative" x-data="{ searchQuery: '', searchResults: [], isSearching: false }">
                                <div class="relative">
                        ...
                        <!-- Dark Mode Toggle and Profile - Always Visible -->
